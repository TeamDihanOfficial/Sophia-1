...
from Sophia.pyrogramee.pluginhelpers import edit_or_reply
from Sophia.pyrogramee.pluginhelpers import convert_to_image
...
__help__ = """ *BoyCot Image* - Creates Boycott Image Like this
/boycott (reply to image)

Special Thanks @miss_musicybot
"""
